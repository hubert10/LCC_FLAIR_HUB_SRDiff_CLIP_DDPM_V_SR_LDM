...
which python
cd $HOME/LCC_FLAIR_HUB_SRDiff_CLIP_DDPM_V_SR_LDM
srun python trainer.py --config configs/diffsr_maxvit_ltae.yaml --config_file flair-config-server.yml --exp_name misr/srdiff_highresnet_ltae_ckpt --hparams="cond_net_ckpt=/bigwork/nhgnkany/Results/LCC_FLAIR_HUB_SRDiff_CLIP_DDPM_V_SR_LDM/results/checkpoints/misr/srdiff_highresnet_ltae_ckpt" --infer
