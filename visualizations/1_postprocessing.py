...
msk_folder_aerial = BIGWORK_DIR + "/LCC_FLAIR_HUB_SRDiff_CLIP_DDPM_V_SR_LDM/PR/"
pred_folder_aerial = BIGWORK_DIR + "/LCC_FLAIR_HUB_SRDiff_CLIP_DDPM_V_SR_LDM/results"
